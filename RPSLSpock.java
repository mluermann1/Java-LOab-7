...
public class RPSLSpock {
    ...
    /**Determines if the pick is a valid choice
     *
     * @param pick One of the choices, rock paper, scissors, lizard, spock or an incorrect choice
     * @return true if the pick is valid, false if not
     */
    ...
    /** computer generates a choice to oppose you with
     *
     * @return returns choice for the computer
     */
